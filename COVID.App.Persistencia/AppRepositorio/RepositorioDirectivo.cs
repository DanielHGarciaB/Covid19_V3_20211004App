...
namespace COVID.App.Persistencia  
{
    public class RepositorioDirectivo : IRepositorioDirectivo
    {
        ...
        IQueryable<Directivo> IRepositorioDirectivo.GetDirectivo(int idDirectivo)
        {
            ...
            IQueryable<Directivo> directivos = _appContext.Directivos.Where(p => p.id == idDirectivo);
            var DirectivoEncontrado= directivos;
            return DirectivoEncontrado;
        }
