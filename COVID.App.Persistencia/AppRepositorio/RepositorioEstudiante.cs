...

{
    public class RepositorioEstudiante : IRepositorioEstudiante
    {
        ...
        IQueryable<Estudiante> IRepositorioEstudiante.GetEstudiante(int idEstudiante)//Estudiante
        {
            ...
            IQueryable<Estudiante> estudiantes = _appContext.Estudiantes.Where(p => p.id == idEstudiante);
