...

{
    public class RepositorioPersonal_Aseo : IRepositorioPersonal_Aseo
    {
       ...
       IQueryable<Personal_Aseo> IRepositorioPersonal_Aseo.GetPersonal_Aseo(int idPersonal_Aseo)
        {
           
            /*var Personal_AseoEncontrado= _appContext.Personal_Aseo.FirstOrDefault(p => p.id == idPersonal_Aseo);
            return Personal_AseoEncontrado;*/

            IQueryable<Personal_Aseo> personalaseo = _appContext.Personal_Aseo.Where(p => p.id == idPersonal_Aseo);
            var PersonalAseoEncontrado= personalaseo;
